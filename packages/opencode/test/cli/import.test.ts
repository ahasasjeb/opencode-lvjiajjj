...
test("parses valid share URLs", () => {
  expect(parseShareUrl("https://opencode.lzy1.fun/share/Jsj3hNIW")).toBe("Jsj3hNIW")
...
test("rejects invalid URLs", () => {
  expect(parseShareUrl("https://opencode.lzy1.fun/s/Jsj3hNIW")).toBeNull() // legacy format
  expect(parseShareUrl("https://opencode.lzy1.fun/share/")).toBeNull()
  expect(parseShareUrl("https://opencode.lzy1.fun/share/id/extra")).toBeNull()
