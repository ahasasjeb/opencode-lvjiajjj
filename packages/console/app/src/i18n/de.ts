...
export const dict = {
  ...
  "zen.api.error.requestBlockedByUpstreamProvider": "Dieses Konto wurde wegen Betrugs oder eines Verstoßes gegen die Nutzungsbedingungen gesperrt. Falls Sie glauben, dass dies ein Irrtum ist, senden Sie bitte eine E-Mail an help@anoma.ly.",
