...
export const dict = {
  ...
  "zen.api.error.requestBlockedByUpstreamProvider": "Questo account è stato ritenuto responsabile di frodi o di violazione dei termini di servizio ed è stato bloccato. Se ritieni che si tratti di un errore, invia un'e-mail a help@anoma.ly.",
