...
export const dict = {
  ...
  "zen.api.error.requestBlockedByUpstreamProvider": "Этот аккаунт уличён в мошенничестве или нарушении условий использования и заблокирован. Если вы считаете, что это ошибка, напишите на help@anoma.ly.",
