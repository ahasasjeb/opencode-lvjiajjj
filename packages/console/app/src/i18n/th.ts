...
export const dict = {
  ...
  "zen.api.error.requestBlockedByUpstreamProvider": "บัญชีนี้ถูกพบว่ามีการฉ้อโกงหรือละเมิดข้อกำหนดในการให้บริการและถูกบล็อก หากคุณเชื่อว่านี่เป็นข้อผิดพลาด โปรดส่งอีเมลไปที่ help@anoma.ly",
