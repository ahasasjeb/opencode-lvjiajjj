...
export const dict = {
  ...
  "zen.api.error.requestBlockedByUpstreamProvider": "Ce compte a été reconnu coupable de fraude ou de violation des conditions d'utilisation et a été bloqué. Si vous pensez qu'il s'agit d'une erreur, veuillez envoyer un e-mail à help@anoma.ly.",
