export const dict = {
  ...
  "format.users": "utenti",
  "format.tokens": "token",
  "nav.modelCompare": "Confronta modelli",
  "compare.title": "Confronto modelli AI",
  "compare.description": "Confronta modelli AI su benchmark, prezzo, lunghezza del contesto e altre funzionalità.",
  "compare.breadcrumb": "Breadcrumb",
  "compare.breadcrumbData": "Dati",
  "compare.breadcrumbCompare": "Confronta",
  "compare.heroAria": "Compare AI models",
  "compare.heroCompare": "Confronta",
  "compare.heroAiModels": "modelli AI",
  ...
  "compare.relatedTitle": "Confronti correlati",
  ...
  "compare.searchModels": "Cerca modelli",
  "compare.addModel": "Aggiungi modello",
  "compare.highlightBest": "Highlight best",
  "compare.selectedModels": "Selected models",
  "compare.modelComparison": "Confronto modelli",
  ...
  "compare.section.overview": "Panoramica",
  "compare.section.pricing": "Prezzi",
  "compare.section.momentum": "Momentum",
  "compare.section.retention": "Retenzione",
  "compare.badge.last2mo": "Last 2 mo",
  "compare.badge.week1": "Settimana 1",
  ...
  "compare.row.returningUsers": "Utenti di ritorno",
  ...
  "compare.true": "True",
  "compare.false": "False",
  "compare.noUsage": "Nessun utilizzo",
  "compare.unit.userWeeks": "settimane-utente",
  "compare.noData": "No data",
  "compare.unknown": "Sconosciuto",
  ...
  "compare.modelFromLab": "{{name}} è un modello AI di {{lab}}.",
  "compare.free": "Gratis",
  "compare.tryAnotherSearch": "Prova un'altra ricerca.",
  "compare.uptime": "Uptime",
} as const
