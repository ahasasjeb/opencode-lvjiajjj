export const dict = {
  ...
  "nav.modelCompare": "Порівняння моделей",
  "compare.title": "Порівняння моделей ШІ",
  "compare.description": "Порівнюйте моделі ШІ за бенчмарками, ціною, довжиною контексту та іншими можливостями.",
  "compare.breadcrumb": "Breadcrumb",
  "compare.breadcrumbData": "Дані",
  "compare.breadcrumbCompare": "Порівняти",
  "compare.heroAria": "Compare AI models",
  "compare.heroCompare": "Порівняти",
  "compare.heroAiModels": "моделі ШІ",
  ...
  "compare.relatedTitle": "Пов’язані порівняння",
  ...
  "compare.searchModels": "Шукати моделі",
  "compare.addModel": "Додати модель",
  "compare.highlightBest": "Highlight best",
  "compare.selectedModels": "Selected models",
  "compare.modelComparison": "Порівняння моделей",
  ...
  "compare.section.overview": "Огляд",
  "compare.section.pricing": "Ціни",
  "compare.section.momentum": "Momentum",
  "compare.section.retention": "Утримання",
  "compare.badge.last2mo": "Last 2 mo",
  "compare.badge.week1": "Тиждень 1",
  ...
  "compare.row.returningUsers": "Користувачі, що повернулися",
  ...
  "compare.true": "True",
  "compare.false": "False",
  "compare.noUsage": "Немає використання",
  "compare.unit.userWeeks": "користувацькі тижні",
  "compare.noData": "No data",
  "compare.unknown": "Невідомо",
  ...
  "compare.modelFromLab": "{{name}} — модель ШІ від {{lab}}.",
  "compare.free": "Безкоштовно",
  "compare.tryAnotherSearch": "Спробуйте інший пошук.",
  "compare.uptime": "Час роботи",
} as const
