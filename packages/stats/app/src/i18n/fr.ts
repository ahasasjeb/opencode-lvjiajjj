export const dict = {
  ...
  "nav.modelCompare": "Comparer les modèles",
  "compare.title": "Comparaison de modèles d'IA",
  "compare.description":
    "Comparez les modèles d'IA sur les benchmarks, le prix, la longueur de contexte et d'autres fonctionnalités.",
  "compare.breadcrumb": "Fil d'Ariane",
  "compare.breadcrumbData": "Données",
  "compare.breadcrumbCompare": "Comparer",
  "compare.heroAria": "Comparer les modèles d'IA",
  "compare.heroCompare": "Comparer",
  "compare.heroAiModels": "modèles d'IA",
  "compare.selectorAria": "Choisir les modèles à comparer",
  "compare.emptyTitle": "Aucun modèle trouvé",
  "compare.emptyDescription": "La liste des modèles n'a pas pu être chargée.",
  "compare.relatedTitle": "Comparaisons associées",
  "compare.relatedDescription": "D'autres paires de modèles à consulter.",
  "compare.selectorLabel": "Sélecteur de comparaison de modèles",
  "compare.firstModel": "Premier modèle",
  "compare.secondModel": "Deuxième modèle",
  "compare.chooseFirst": "Choisir le premier modèle",
  "compare.chooseSecond": "Choisir le deuxième modèle",
  "compare.selectModel": "Sélectionner un modèle",
  "compare.searchModels": "Rechercher des modèles",
  "compare.addModel": "Ajouter un modèle",
  "compare.highlightBest": "Mettre en avant le meilleur",
  "compare.selectedModels": "Modèles sélectionnés",
  "compare.modelComparison": "Comparaison de modèles",
  "compare.modelComparisonUpper": "COMPARAISON DE MODÈLES",
  "compare.cardsTitle": "Comparaisons de modèles",
  "compare.cardsDescription": "Comparez usage, coût, limites et fonctionnalités.",
  "compare.capabilities": "Capacités des modèles",
  "compare.category.flagship.title": "Modèles phares",
  "compare.category.flagship.description": "Les derniers modèles haut de gamme des grands labs.",
  "compare.category.affordable.title": "Les plus abordables",
  "compare.category.affordable.description": "Modèles compacts et économiques pour haut débit.",
  "compare.category.code.title": "Meilleurs pour le code",
  "compare.category.code.description": "Souvent choisis pour la programmation.",
  "compare.category.image.title": "Génération d'images",
  "compare.category.image.description": "Comparer les meilleurs modèles d'image en coût et qualité.",
  "compare.section.overview": "Aperçu",
  "compare.section.pricing": "Tarifs",
  "compare.section.momentum": "Dynamique",
  "compare.section.retention": "Rétention",
  "compare.badge.last2mo": "2 derniers mois",
  "compare.badge.week1": "Semaine 1",
  "compare.row.author": "Auteur",
  "compare.row.contextLength": "Longueur de contexte",
  "compare.row.reasoning": "Raisonnement",
  "compare.row.inputModalities": "Modalités d'entrée",
  "compare.row.outputModalities": "Modalités de sortie",
  "compare.row.providers": "Fournisseurs",
  "compare.row.input": "Entrée",
  "compare.row.output": "Sortie",
  "compare.row.cachedInput": "Entrée en cache",
  "compare.row.uniqueUsers": "Utilisateurs uniques",
  "compare.row.completedSessions": "Sessions terminées",
  "compare.row.tokenShare": "Part de tokens",
  "compare.row.tokens": "Tokens",
  "compare.row.returningUsers": "Utilisateurs récurrents",
  "compare.fact.release": "Sortie",
  "compare.fact.context": "Contexte",
  "compare.fact.input": "Entrée",
  "compare.fact.output": "Sortie",
  "compare.fact.url": "URL",
  "compare.nearbyAlternative": "Alternative proche",
  "compare.relatedComparison": "Comparaison associée",
  "compare.catalog": "Catalogue",
  "compare.true": "Oui",
  "compare.false": "Non",
  "compare.noUsage": "Aucune utilisation",
  "compare.unit.userWeeks": "semaines-utilisateur",
  "compare.noData": "Aucune donnée",
  "compare.unknown": "Inconnu",
  "compare.listed": "Référencé",
  "compare.modelN": "Modèle {{n}}",
  "compare.chooseModelN": "Choisir le modèle {{n}}",
  "compare.radar.reasoning": "Raisonnement",
  "compare.radar.reasoningDesc":
    "Capacité à résoudre des problèmes complexes en plusieurs étapes. Basé sur les benchmarks de raisonnement si disponibles.",
  "compare.radar.coding": "Codage",
  "compare.radar.codingDesc": "Performance sur les benchmarks d'ingénierie logicielle et de codage.",
  "compare.radar.cost": "Efficacité coût",
  "compare.radar.costDesc": "Tarification relative entrée/sortie. Les modèles moins chers marquent plus.",
  "compare.radar.context": "Fenêtre de contexte",
  "compare.radar.contextDesc": "Quantité d'entrée traitable d'un coup. Les fenêtres plus grandes marquent plus.",
  "compare.radar.multimodal": "Multimodal",
  "compare.radar.multimodalDesc": "Prise en charge des entrées/sorties non textuelles, dont images, audio et vidéo.",
  "compare.radar.toolUse": "Outils",
  "compare.radar.toolUseDesc": "Performance sur les benchmarks agent, dont Terminal-Bench, Tau3 et Claw-Eval.",
  "compare.modelFromLab": "{{name}} est un modèle d'IA de {{lab}}.",
  "compare.free": "Gratuit",
  "compare.tryAnotherSearch": "Essayez une autre recherche.",
  "compare.uptime": "Disponibilité",
} as const
