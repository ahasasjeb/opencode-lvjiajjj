export const dict = {
  ...
  "format.tokens": "token",
  "nav.modelCompare": "Modelleri karşılaştır",
  "compare.title": "AI model karşılaştırması",
  "compare.description":
    "AI modellerini kıyaslamalar, fiyat, bağlam uzunluğu ve diğer özelliklere göre karşılaştırın.",
  "compare.breadcrumb": "Breadcrumb",
  "compare.breadcrumbData": "Veri",
  "compare.breadcrumbCompare": "Karşılaştır",
  "compare.heroAria": "Compare AI models",
  "compare.heroCompare": "Karşılaştır",
  "compare.heroAiModels": "AI modelleri",
  ...
  "compare.relatedTitle": "İlgili karşılaştırmalar",
  ...
  "compare.section.pricing": "Fiyatlandırma",
  "compare.section.momentum": "Momentum",
  "compare.section.retention": "Elde tutma",
  "compare.badge.last2mo": "Last 2 mo",
  "compare.badge.week1": "1. hafta",
  ...
  "compare.row.returningUsers": "Geri dönen kullanıcılar",
  ...
  "compare.true": "True",
  "compare.false": "False",
  "compare.noUsage": "Kullanım yok",
  "compare.unit.userWeeks": "kullanıcı haftası",
  "compare.noData": "No data",
  "compare.unknown": "Bilinmiyor",
  ...
  "compare.modelFromLab": "{{name}}, {{lab}} kaynaklı bir AI modelidir.",
  "compare.free": "Ücretsiz",
  "compare.tryAnotherSearch": "Başka bir arama dene.",
  "compare.uptime": "Çalışma süresi",
} as const
