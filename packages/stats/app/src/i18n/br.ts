export const dict = {
  ...
  "compare.title": "Comparação de modelos de IA",
  "compare.description": "Compare modelos de IA em benchmarks, preço, comprimento de contexto e outros recursos.",
  "compare.breadcrumb": "Breadcrumb",
  "compare.breadcrumbData": "Dados",
  ...
  "compare.relatedTitle": "Comparações relacionadas",
  ...
  "compare.searchModels": "Pesquisar modelos",
  "compare.addModel": "Adicionar modelo",
  "compare.highlightBest": "Highlight best",
  "compare.selectedModels": "Selected models",
  "compare.modelComparison": "Comparação de modelos",
  ...
  "compare.section.overview": "Visão geral",
  "compare.section.pricing": "Preços",
  "compare.section.momentum": "Momentum",
  "compare.section.retention": "Retenção",
  ...
  "compare.row.returningUsers": "Usuários recorrentes",
  ...
  "compare.true": "True",
  "compare.false": "False",
  "compare.noUsage": "Sem uso",
  "compare.unit.userWeeks": "semanas de usuários",
  ...
  "compare.modelFromLab": "{{name}} é um modelo de IA da {{lab}}.",
  "compare.free": "Grátis",
  "compare.tryAnotherSearch": "Tente outra busca.",
  "compare.uptime": "Disponibilidade",
} as const
