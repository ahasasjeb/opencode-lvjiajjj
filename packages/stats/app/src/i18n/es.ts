export const dict = {
  ...
  "nav.modelCompare": "Comparar modelos",
  "compare.title": "Comparación de modelos de IA",
  "compare.description": "Compara modelos de IA por benchmarks, precio, longitud de contexto y otras capacidades.",
  "compare.breadcrumb": "Ruta de navegación",
  "compare.breadcrumbData": "Datos",
  "compare.breadcrumbCompare": "Comparar",
  "compare.heroAria": "Comparar modelos de IA",
  "compare.heroCompare": "Comparar",
  "compare.heroAiModels": "modelos de IA",
  "compare.selectorAria": "Elige modelos para comparar",
  "compare.emptyTitle": "No se encontraron modelos",
  "compare.emptyDescription": "No se pudo cargar la lista de modelos.",
  "compare.relatedTitle": "Comparaciones relacionadas",
  "compare.relatedDescription": "Otros pares de modelos para revisar.",
  "compare.selectorLabel": "Selector de comparación de modelos",
  "compare.firstModel": "Primer modelo",
  "compare.secondModel": "Segundo modelo",
  "compare.chooseFirst": "Elegir primer modelo",
  "compare.chooseSecond": "Elegir segundo modelo",
  "compare.selectModel": "Seleccionar un modelo",
  "compare.searchModels": "Buscar modelos",
  "compare.addModel": "Añadir modelo",
  "compare.highlightBest": "Resaltar el mejor",
  "compare.selectedModels": "Modelos seleccionados",
  "compare.modelComparison": "Comparación de modelos",
  "compare.modelComparisonUpper": "COMPARACIÓN DE MODELOS",
  "compare.cardsTitle": "Comparaciones de modelos",
  "compare.cardsDescription": "Compara uso, coste, límites y funciones.",
  "compare.capabilities": "Capacidades del modelo",
  "compare.category.flagship.title": "Modelos insignia",
  "compare.category.flagship.description": "Los últimos modelos de primer nivel de los principales labs.",
  "compare.category.affordable.title": "Más asequibles",
  "compare.category.affordable.description": "Modelos compactos y baratos para alto rendimiento.",
  "compare.category.code.title": "Mejores para código",
  "compare.category.code.description": "Elegidos a menudo para tareas de programación.",
  "compare.category.image.title": "Generación de imágenes",
  "compare.category.image.description": "Compara modelos de imagen top por coste y calidad.",
  "compare.section.overview": "Resumen",
  "compare.section.pricing": "Precios",
  "compare.section.momentum": "Impulso",
  "compare.section.retention": "Retención",
  "compare.badge.last2mo": "Últimos 2 mes.",
  "compare.badge.week1": "Semana 1",
  "compare.row.author": "Autor",
  "compare.row.contextLength": "Longitud de contexto",
  "compare.row.reasoning": "Razonamiento",
  "compare.row.inputModalities": "Modalidades de entrada",
  "compare.row.outputModalities": "Modalidades de salida",
  "compare.row.providers": "Proveedores",
  "compare.row.input": "Entrada",
  "compare.row.output": "Salida",
  "compare.row.cachedInput": "Entrada en caché",
  "compare.row.uniqueUsers": "Usuarios únicos",
  "compare.row.completedSessions": "Sesiones completadas",
  "compare.row.tokenShare": "Cuota de tokens",
  "compare.row.tokens": "Tokens",
  "compare.row.returningUsers": "Usuarios recurrentes",
  "compare.fact.release": "Lanzamiento",
  "compare.fact.context": "Contexto",
  "compare.fact.input": "Entrada",
  "compare.fact.output": "Salida",
  "compare.fact.url": "URL",
  "compare.nearbyAlternative": "Alternativa cercana",
  "compare.relatedComparison": "Comparación relacionada",
  "compare.catalog": "Catálogo",
  "compare.true": "Sí",
  "compare.false": "No",
  "compare.noUsage": "Sin uso",
  "compare.unit.userWeeks": "semanas de usuario",
  "compare.noData": "Sin datos",
  "compare.unknown": "Desconocido",
  "compare.listed": "Listado",
  "compare.modelN": "Modelo {{n}}",
  "compare.chooseModelN": "Elegir modelo {{n}}",
  "compare.radar.reasoning": "Razonamiento",
  "compare.radar.reasoningDesc":
    "Capacidad para resolver problemas complejos de varios pasos. Basado en benchmarks de razonamiento si hay datos.",
  "compare.radar.coding": "Código",
  "compare.radar.codingDesc": "Rendimiento en benchmarks de ingeniería de software y código.",
  "compare.radar.cost": "Eficiencia de coste",
  "compare.radar.costDesc": "Precios relativos de entrada y salida. Los más baratos puntúan más.",
  "compare.radar.context": "Ventana de contexto",
  "compare.radar.contextDesc": "Cuánta entrada puede procesar de una vez. Más grande, mayor puntuación.",
  "compare.radar.multimodal": "Multimodal",
  "compare.radar.multimodalDesc": "Soporte de entrada/salida no textual, incluidas imagen, audio y vídeo.",
  "compare.radar.toolUse": "Uso de herramientas",
  "compare.radar.toolUseDesc": "Rendimiento en benchmarks de agentes, incluidos Terminal-Bench, Tau3 y Claw-Eval.",
  "compare.modelFromLab": "{{name}} es un modelo de IA de {{lab}}.",
  "compare.free": "Gratis",
  "compare.tryAnotherSearch": "Prueba otra búsqueda.",
  "compare.uptime": "Tiempo activo",
} as const
